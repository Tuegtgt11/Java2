    ...
    public static void main(String[] args) {
        try (
                Connection conn = DriverManager.getConnection(
                        "jdbc:mysql://localhost:3306/drinks?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
                        "root", "");
            ...
            do {
                ...
                switch (y) {
                    case 1:
                        ...
                        String insert1= "insert into listdrinks values(?,?,?,?)";
                        ...
                        String check1 = "select * from listdrinks WHERE drinks = '"+ name1 +"';";
                    ...
                    case 2:
                        ...
                        String check2 = "select * from listdrinks WHERE drinks = '"+ name2 +"';";
                    ...
                    case 3:
                        ...
                        String update3 ="UPDATE listdrinks"+" SET drink=?,price=?,manufacturer=?"+" WHERE id=?";
                    ...
                    case 4:
                        ...
                        String delete4 = "DELETE FROM listdrinks WHERE drinks ='"+name4+"';";
                        PreparedStatement pstmt4 = conn.prepareStatement(delete4);
                        pstmt4.executeUpdate();
                        System.out.println("DELETED!");
                        break;
                    case 5:
                        String strSelect = "select * from listdrinks";
